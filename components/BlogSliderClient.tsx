    ...
    <section id="blog">
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-slate-400">Tech Blogs</p>
            <h2 className="mt-4 text-3xl font-semibold text-slate-50 md:text-4xl">Latest writing & research notes.</h2>
          </div>
        ...
        <div ref={sliderRef} className="mt-10 flex gap-6 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-4">
          {blogPosts.map((post) => (
            ...
            >
              ...
              <a href={post.url} className="mt-6 inline-flex text-sm font-medium text-accent underline-offset-4 hover:underline">
                Read More
              </a>
            </motion.article>
          ))}
