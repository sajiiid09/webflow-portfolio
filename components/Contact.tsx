    ...
    <section id="contact">
      <div className="mx-auto max-w-6xl px-6">
        <motion.div
          ...
          className="glass-surface grid gap-12 rounded-3xl p-8 text-slate-50 md:grid-cols-2"
        >
          <div>
          ...
          <div className="flex flex-col gap-6">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.button
                ...
                className="glass-button w-full justify-center px-4 py-3 text-sm font-semibold disabled:cursor-not-allowed disabled:opacity-60"
              >
