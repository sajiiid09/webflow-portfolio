  ...
  return (
    <section id="home" className="relative flex min-h-[90vh] items-center overflow-hidden">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 pt-28 md:flex-row md:items-center">
        ...
        >
          <p className="text-sm uppercase tracking-[0.5em] text-slate-300">Creative Developer</p>
          <h1 className="text-4xl font-semibold leading-tight text-gradient-copper md:text-6xl">Sajid Mahmud</h1>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="glass-button mt-6 inline-flex items-center px-6 py-3 text-sm font-semibold"
          >
            Explore My Work
          </motion.a>
        </motion.div>
