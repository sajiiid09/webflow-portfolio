  ...
  return (
    <section id="skills" className="bg-transparent">
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          <p className="text-sm uppercase tracking-[0.3em] text-slate-300">Core Skills</p>
        ...
        <div className="mt-16 overflow-hidden rounded-2xl border border-white/10 bg-white/5 py-6 backdrop-blur-md">
            ...
            {[...technologies, ...technologies].map((tech, index) => {
              ...
              return (
                <span
                  ...
                  className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/10 px-5 py-2 text-sm text-slate-200 shadow-sm backdrop-blur"
                >
