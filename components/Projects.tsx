    ...
    <section id="projects">
      <div className="mx-auto max-w-6xl px-6">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <p className="text-sm uppercase tracking-[0.3em] text-slate-300">Selected Work</p>
          <h2 className="mt-4 text-3xl font-semibold md:text-4xl text-slate-50">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          {projects.map((project) => (
            <motion.article
              ...
              className="glass-surface glass-card flex flex-col rounded-3xl p-6 text-slate-100"
            >
              ...
              <div className="mt-6 flex gap-3">
                <motion.a
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="glass-button flex-1 justify-center px-4 py-2 text-center text-sm font-semibold"
                >
                  Live Demo
                </motion.a>
                <motion.a
                  ...
                  whileHover={{ scale: 1.03 }}
                  whileTap={{ scale: 0.97 }}
                  className="glass-button flex-1 justify-center bg-white/10 px-4 py-2 text-center text-sm font-semibold"
                >
                  Code
                </motion.a>
              </div>
