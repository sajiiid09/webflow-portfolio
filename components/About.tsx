  ...
  return (
    <section id="about">
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          <p className="text-sm uppercase tracking-[0.3em] text-slate-300">About Me</p>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            {stats.map((stat) => (
              <div key={stat.label} className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
